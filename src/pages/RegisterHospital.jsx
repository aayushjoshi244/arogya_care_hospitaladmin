              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="sm:col-span-3">
                  ...
                  {form.google_maps_link && /google\.com\/maps|goo\.gl|maps\.app/i.test(form.google_maps_link) ? (
                    <div className="flex items-center gap-2 mt-2 text-[11px] font-bold text-teal-700 bg-teal-50 border border-teal-200 rounded-lg px-3 py-2">
                      <LocateFixed size={13} className="shrink-0 text-teal-600" />
